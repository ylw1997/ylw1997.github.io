import{_ as s,o as a,c as n,V as l}from"./chunks/framework.b1ba171e.js";const A=JSON.parse('{"title":"spring cloud bootstrap.yml多环境配置","description":"","frontmatter":{},"headers":[],"relativePath":"back/java/bootstrap.md","filePath":"back/java/bootstrap.md","lastUpdated":1675671779000}'),p={name:"back/java/bootstrap.md"},o=l(`<h1 id="spring-cloud-bootstrap-yml多环境配置" tabindex="-1">spring cloud bootstrap.yml多环境配置 <a class="header-anchor" href="#spring-cloud-bootstrap-yml多环境配置" aria-label="Permalink to &quot;spring cloud bootstrap.yml多环境配置&quot;">​</a></h1><h2 id="spring-boot-多环境配置" tabindex="-1">spring boot 多环境配置 <a class="header-anchor" href="#spring-boot-多环境配置" aria-label="Permalink to &quot;spring boot 多环境配置&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><ul><li>application.yml #主配置</li><li>application-dev.yml #开发配置</li><li>application-test.yml #测试配置</li><li>application-prod.yml #正式配置</li></ul></div><h2 id="spring-cloud-多环境配置" tabindex="-1">spring cloud 多环境配置 <a class="header-anchor" href="#spring-cloud-多环境配置" aria-label="Permalink to &quot;spring cloud 多环境配置&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><ul><li>spring cloud 使用配置中心,使用bootstrap.yml来配置</li><li>bootstrap.yml 先加载 application.yml后加载</li><li>Bootstrap 属性有高优先级，默认情况下，它们不会被本地配置覆盖。</li></ul></div><h2 id="配置方法" tabindex="-1">配置方法 <a class="header-anchor" href="#配置方法" aria-label="Permalink to &quot;配置方法&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">配置方法</p><ul><li>多个配置以 <code>---</code>分开</li><li>通过spring.profiles.active 来使用配置</li><li>通过config.activate.on-profile 来命名环境</li></ul></div><div class="language-yml"><button title="Copy Code" class="copy"></button><span class="lang">yml</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># Tomcat</span></span>

import{_ as s,o as n,c as a,d as l}from"./app.b9a5d55a.js";const A=JSON.parse('{"title":"spring cloud bootstrap.yml多环境配置","description":"","frontmatter":{},"headers":[{"level":2,"title":"spring boot 多环境配置","slug":"spring-boot-多环境配置","link":"#spring-boot-多环境配置","children":[]},{"level":2,"title":"spring cloud 多环境配置","slug":"spring-cloud-多环境配置","link":"#spring-cloud-多环境配置","children":[]},{"level":2,"title":"配置方法","slug":"配置方法","link":"#配置方法","children":[]},{"level":2,"title":"使用配置","slug":"使用配置","link":"#使用配置","children":[]}],"relativePath":"back/java/bootstrap.md","lastUpdated":1675671779000}'),p={name:"back/java/bootstrap.md"},o=l(`<h1 id="spring-cloud-bootstrap-yml多环境配置" tabindex="-1">spring cloud bootstrap.yml多环境配置 <a class="header-anchor" href="#spring-cloud-bootstrap-yml多环境配置" aria-hidden="true">#</a></h1><h2 id="spring-boot-多环境配置" tabindex="-1">spring boot 多环境配置 <a class="header-anchor" href="#spring-boot-多环境配置" aria-hidden="true">#</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><ul><li>application.yml #主配置</li><li>application-dev.yml #开发配置</li><li>application-test.yml #测试配置</li><li>application-prod.yml #正式配置</li></ul></div><h2 id="spring-cloud-多环境配置" tabindex="-1">spring cloud 多环境配置 <a class="header-anchor" href="#spring-cloud-多环境配置" aria-hidden="true">#</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><ul><li>spring cloud 使用配置中心,使用bootstrap.yml来配置</li><li>bootstrap.yml 先加载 application.yml后加载</li><li>Bootstrap 属性有高优先级，默认情况下，它们不会被本地配置覆盖。</li></ul></div><h2 id="配置方法" tabindex="-1">配置方法 <a class="header-anchor" href="#配置方法" aria-hidden="true">#</a></h2><div class="tip custom-block"><p class="custom-block-title">配置方法</p><ul><li>多个配置以 <code>---</code>分开</li><li>通过spring.profiles.active 来使用配置</li><li>通过config.activate.on-profile 来命名环境</li></ul></div><div class="language-yml"><button title="Copy Code" class="copy"></button><span class="lang">yml</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># Tomcat</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#F07178;">activate</span><span style="color:#89DDFF;">:</span></span>
<span class="line"><span style="color:#89DDFF;">      </span><span style="color:#676E95;font-style:italic;"># 环境名称</span></span>
<span class="line"><span style="color:#A6ACCD;">      </span><span style="color:#F07178;">on-profile</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">prod</span></span>
<span class="line"></span></code></pre></div><h2 id="使用配置" tabindex="-1">使用配置 <a class="header-anchor" href="#使用配置" aria-hidden="true">#</a></h2><div class="tip custom-block"><p class="custom-block-title">使用</p><ul><li><code>java -jar -Dspring.profiles.active=prod *****.jar</code></li></ul></div>`,10),e=[o];function c(t,r,i,y,D,F){return n(),a("div",null,e)}const d=s(p,[["render",c]]);export{A as __pageData,d as default};
